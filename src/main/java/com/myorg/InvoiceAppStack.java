...
public class InvoiceAppStack extends Stack {
    ...
    private final Queue s3IvoiceQueue;
    ...
    public InvoiceAppStack(final Construct scope, final String id, final StackProps props) {
        ...
        Queue s3InvoiceDlq = Queue.Builder.create(this, "S3InvoiceDlq")
                .queueName("s3-invoice-envents-dlq")
                .build();
        ...
        s3IvoiceQueue = Queue.Builder.create(this, "S3InvoiceQueue")
                .queueName("s3-invoice-events")
                .deadLetterQueue(deadLetterQueue)
                .build();

        SqsSubscription sqsSubscription = SqsSubscription.Builder.create(s3IvoiceQueue).build();
    ...
    public Queue getS3IvoiceQueue() {
        return s3IvoiceQueue;
    }
}
